...
//import Vanityﾒ𝟶Linoria from "@/components/ui/linorialib/Vanityﾒ𝟶-linoria";
          ...
          title={
            <div className="flex flex-col items-center justify-center">
              <BlurFade delay={0.2 + (1 * 0.05)}>
                <Link href={"https://discord.gg/Vanityﾒ𝟶"} target="_blank">
              ...
              <BlurFade delay={0.2 + (4 * 0.05)}>
                <div className="flex flex-row items-center justify-center mt-2 gap-2">
                  ...
                  <CopyButton text={'https://docs.upio.dev/Vanityﾒ𝟶/key-system'} />
                  <Link href={"https://discord.gg/Vanityﾒ𝟶"} target="_blank">
      ...
      <div className="flex flex-col items-center justify-center px-2 text-center">
        ...
        <BlurFade delay={0.2 + (4 * 0.05)} inView>
          <Accordion type="single" collapsible className="max-w-[1000px] w-[50vw] max-md:w-[75vw]">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                Tutorial on how to use the Key System is here: <Link href={"https://docs.upio.dev/Vanityﾒ𝟶/key-system"} target="_blank" className="text-blue-300 underline">https://docs.upio.dev/Vanityﾒ𝟶/key-system</Link>.
              </AccordionContent>
            </AccordionItem>
        ...
        <div className="px-10 py-6 w-screen flex flex-row justify-between items-center max-md:justify-center max-md:flex-col">
          <div className="px-2 py-2 flex flex-row items-center gap-2">
            <Image alt="Vanityﾒ𝟶" src="/icon.png" width={25} height={25} />
            <div>
